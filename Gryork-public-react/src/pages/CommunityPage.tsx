  ...
  return (
    <SectionShell variant="light">
      <div className="mx-auto max-w-6xl px-4">
        <AnimatedReveal>
          <p className="badge-info mb-4">Community Network</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {platforms.map((platform) => (
            <SignatureCard key={platform.name} variant="story" className="p-6">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <SignatureCard variant="proof" className="p-6">
            ...
            <WorkflowDiagramMock variant="community-network" className="mt-4" />
          </SignatureCard>
        </div>
      </div>
    </SectionShell>
