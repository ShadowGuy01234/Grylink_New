...
const OnboardingPage = () => {
  ...
  const partnerPortalUrl =
    import.meta.env.VITE_PARTNER_PORTAL_URL || "http://localhost:5175";
  const publicSiteUrl =
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl border border-red-100 max-w-md w-full p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mb-6">
            If you believe this is an error, please contact your Gryork sales
            representative.
          </p>
          <a
            href={publicSiteUrl}
  ...
  const isNbfc = linkData?.linkType === "nbfc";
  const ONBOARDING_STEPS = isNbfc
    ? NBFC_ONBOARDING_STEPS
    : EPC_ONBOARDING_STEPS;
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-sky-600">
              Gryork
            </span>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 mb-6 shadow-sm">
          ...
          <div className="space-y-3">
            {ONBOARDING_STEPS.map((step, i) => (
              <div
                key={step.label}
                className={`flex items-center gap-3 ${i === 0 ? "opacity-100" : "opacity-50"}`}
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-sm font-medium ${i === 0 ? "text-indigo-700" : "text-gray-500"}`}
                  >
                    {step.label}
                  </p>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            ...
            <a href={publicSiteUrl} className="text-indigo-500 hover:underline">
              Terms of Service
            </a>{" "}
            and Privacy Policy
          </p>
