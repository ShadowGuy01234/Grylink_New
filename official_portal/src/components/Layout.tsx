...
> = {
  sales: {
    primary: "#1E5AAF",
    light: "rgba(30,90,175,0.09)",
    gradient: "linear-gradient(135deg,#1E5AAF,#3B82F6)",
  },
  ops: {
    primary: "#15803D",
    light: "rgba(21,128,61,0.09)",
    gradient: "linear-gradient(135deg,#15803D,#22C55E)",
  },
  rmt: {
    primary: "#B45309",
    light: "rgba(180,83,9,0.09)",
    gradient: "linear-gradient(135deg,#B45309,#F59E0B)",
  },
  admin: {
    primary: "#0A2463",
    light: "rgba(10,36,99,0.09)",
    gradient: "linear-gradient(135deg,#0A2463,#1E5AAF)",
  },
  founder: {
    primary: "#7C3AED",
...
const Ico = {
  ...
  building: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M3 21h18M3 7l9-4 9 4M4 7v14M20 7v14M9 21v-4h6v4M9 10h.01M12 10h.01M15 10h.01M9 14h.01M12 14h.01M15 14h.01" />
    </svg>
  ),
  users: (
    <svg
  ...
  cog: (
    ...
    >
      ...
      <path d="M19.07 4.93l-1.41 1.41M4.93 4.93l1.41 1.41M4.93 19.07l1.41-1.41M19.07 19.07l-1.41-1.41M22 12h-2M4 12H2M12 2V4M12 22v-2" />
    </svg>
  ),
  star: (
    <svg
        ...
        >
          <div
            style={{
              ...
              borderRadius: 9,
              background:
                "linear-gradient(135deg,#0A2463 0%,#1E5AAF 60%,#3B82F6 100%)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              fontWeight: 800,
